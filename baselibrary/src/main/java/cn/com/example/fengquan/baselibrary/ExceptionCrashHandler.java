package cn.com.example.fengquan.baselibrary;
 ...
 * Description:单例模式的异常捕捉
 */

public class ExceptionCrashHandler implements Thread.UncaughtExceptionHandler {

   public static final ExceptionCrashHandler exceptionHandler = new ExceptionCrashHandler();
   ...
   public void init(Context context){
    ...
    public void uncaughtException(Thread thread, Throwable throwable) {
        ...
        //应用信息  包名  版本号
        //手机信息
        //保存当前文件，等应用再次启动上传 （上传文件不再这里处理）
        String crashFileName = saveInfoToSD(throwable);

        Log.e("fqLog", "fileName --> " + crashFileName);
